...
const PROFILES: Record<string, ClassWeights> = {
  ...
  Paladin: {
    ...
    str: 1.0, sta: 1.5, dex: 0.4, agi: 0.30,
  ...
  "Paladin:dps": {
    ...
    str: 2.0, sta: 1.0, dex: 1.0, agi: 0.18,
  ...
  "Shadow Knight": {
    hp: 1.3, mana: 0.6, ac: 1.0,
    str: 1.2, sta: 1.5, dex: 0.4, agi: 0.30,
  ...
  "Shadow Knight:dps": {
    hp: 1.0, mana: 0.5, ac: 0.6,
    str: 2.2, sta: 1.0, dex: 1.0, agi: 0.18,
  ...
  Ranger: {
    ...
    str: 1.8, sta: 1.2, dex: 1.0, agi: 0.24,
  ...
  Bard: {
    ...
    str: 0.8, sta: 1.0, dex: 1.5, agi: 0.18,
  ...
  Cleric: {
    ...
    str: 0.06, sta: 0.25, dex: 0.03, agi: 0.08,
  ...
  Druid: {
    ...
    str: 0.06, sta: 0.2, dex: 0.03, agi: 0.05,
    wis: 6.0, int: 0.02, cha: 0.05,
    svFire: 0.15, svCold: 0.12, svDisease: 0.08, svMagic: 0.2, svPoison: 0.08,
    weaponRatio: 0, hasteMultiplier: 0,
  },
  Shaman: {
    ...
    str: 0.08, sta: 0.35, dex: 0.05, agi: 0.09,
    wis: 5.5, int: 0.02, cha: 0.1,
    svFire: 0.15, svCold: 0.12, svDisease: 0.08, svMagic: 0.2, svPoison: 0.08,
    weaponRatio: 0, hasteMultiplier: 8,
  },
  Enchanter: {
    hp: 0.3, mana: 0.9, ac: 0.01,
    str: 0.06, sta: 0.15, dex: 0.02, agi: 0.01,
    wis: 0.02, int: 6.0, cha: 4.0,
    svFire: 0.15, svCold: 0.12, svDisease: 0.08, svMagic: 0.2, svPoison: 0.08,
    weaponRatio: 0, hasteMultiplier: 0,
  },
  Magician: {
    hp: 0.25, mana: 0.9, ac: 0.01,
    str: 0.06, sta: 0.15, dex: 0.02, agi: 0.01,
