...
const PROFILES: Record<string, ClassWeights> = {
  Warrior: {
    ...
    ...RESISTS,
    weaponRatio: 85, hasteMultiplier: 30,
  },
  "Warrior:dps": {
    ...
    wis: 0.05, int: 0.05, cha: 0.05,
    ...RESISTS,
    weaponRatio: 100, hasteMultiplier: 35,
  },
  Paladin: {
    ...
    ...RESISTS,
    weaponRatio: 65, hasteMultiplier: 25,
  },
  "Paladin:dps": {
    ...
    ...RESISTS,
    weaponRatio: 75, hasteMultiplier: 28,
  },
  "Shadow Knight": {
    hp: 0.6, mana: 0.6, ac: 1.2,
    str: 2.0, sta: 3.0, dex: 0.8, agi: 0.15,
  ...
  Monk: {
    ...
    wis: 0.05, int: 0.05, cha: 0.05,
    ...RESISTS,
    weaponRatio: 70, hasteMultiplier: 30,
  },
  Rogue: {
  ...
  Bard: {
    ...
    ...RESISTS,
    weaponRatio: 30, hasteMultiplier: 15,
  },
  Cleric: {
  ...
  "Shaman:dps": {
    ...
    ...RESISTS,
    weaponRatio: 30, hasteMultiplier: 18,
  },
  Enchanter: {
